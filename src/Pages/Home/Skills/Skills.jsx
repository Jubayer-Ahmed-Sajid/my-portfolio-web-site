...
const Skills = () => {
    return (
        <div className="skills">
            ...
            <h2 className=' text-4xl text-center  lg:mt-20 py-8'>Skills</h2>
            <div className='grid grid-cols-3 lg:gap-12 gap-4 justify-center items-center  mx-auto  mt-32'>
                ...
                <div><img src="https://i.ibb.co/q9FWKFT/pngfind-com-pc-master-race-png-1363736.png" className='h-8 lg:h-20 mx-auto object-cover' alt="" />
                <p className="text-center font-semibold mt-3 ">Express Js</p></div>
                <div><img src="https://i.ibb.co/G2rsZZb/pngwing-com-2.png" className='h-8 lg:h-20 mx-auto object-cover' alt="" />
                <p className="text-center font-semibold mt-3 ">Node Js</p></div>
                <div><img src="https://i.ibb.co/9cpxRJ2/pngwing-com-3.png" className='h-8 lg:h-20 object-cover mx-auto' alt="" />
                <p className="text-center font-semibold mt-3 ">MongoDB</p></div>
                <div><img src="https://i.ibb.co/VL2f0CW/pngwing-com-1.png" className='h-8 lg:h-20 mx-auto object-cover' alt="" />
                <p className="text-center font-semibold mt-3 ">JavaScript</p></div>
                <div><img src="https://i.ibb.co/VQYXV8t/pngwing-com-4.png" className='h-8 lg:h-20 mx-auto object-cover' alt="" />
